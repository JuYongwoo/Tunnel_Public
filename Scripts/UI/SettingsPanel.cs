    ...
    private readonly Vector2Int[] resolutions = new Vector2Int[]
{
    ...
    protected void Awake()
    {
        ...
        TitlePanel.SettingsPanelOn = () => { settingsPanelObjsMap[SettingsPanelObjs.SettingsPanel].SetActive(true); };
    ...
    public void SliderChangeEvent(float value)
    {
        ManagerObject.instance.sound.UpdateVolume(value);
